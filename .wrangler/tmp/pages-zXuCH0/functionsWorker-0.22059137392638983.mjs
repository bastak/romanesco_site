...
var VOTED_COOKIE = "nmc_voted";
function toHex(buf) {
  return [...new Uint8Array(buf)].map((b) => b.toString(16).padStart(2, "0")).join("");
}
__name(toHex, "toHex");
async function submitterHash(request, salt) {
  const ip = request.headers.get("CF-Connecting-IP") ?? "unknown";
  const ua = request.headers.get("User-Agent") ?? "unknown";
  const data = new TextEncoder().encode(`${ip}|${ua}|${salt}`);
  return toHex(await crypto.subtle.digest("SHA-256", data));
}
__name(submitterHash, "submitterHash");
...
__name(hmac, "hmac");
async function makeVotedCookieValue(salt) {
  const issued = Date.now().toString();
  return `${issued}.${await hmac(issued, salt)}`;
}
__name(makeVotedCookieValue, "makeVotedCookieValue");
async function verifyVotedCookie(value, salt) {
...
__name(verifyVotedCookie, "verifyVotedCookie");
...
// api/vote.ts
var PALETTE = new Set(PALETTE_KEYS);
...
var onRequestPost = /* @__PURE__ */ __name(async ({ request, env }) => {
  ...
  const orderOk = Array.isArray(order) && order.length === NEUROMODULATORS.length && NEUROMODULATORS.every((nm) => order.includes(nm));
  if (!orderOk) {
...
// ../.wrangler/tmp/pages-zXuCH0/functionsRoutes-0.8423964885089515.mjs
var routes = [
  {
...
// ../../../../Users/dororoma/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../Users/dororoma/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../../../../Users/dororoma/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../Users/dororoma/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-xAP1jl/middleware-insertion-facade.js
...
// ../../../../Users/dororoma/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-xAP1jl/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.22059137392638983.mjs.map
